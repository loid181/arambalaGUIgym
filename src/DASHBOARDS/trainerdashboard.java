...
import main.landing;
import trainerDASHBOARD.editprofiletrainer;
import trainermenu.manageclasses;
/**
 *
 * @author Lloyd's PC
 */
...
private void displayUserInfo() {
        ...
        if (sess != null && sess.getFullName() != null) {
            // This retrieves the ID stored during login and assigns it to your local variable
            this.trainer_id = sess.getId(); 
            ...
            System.out.println("ID loaded in Dashboard: " + this.trainer_id);
        } else {
    ...
    private void initComponents() {
        ...
        editprofiletrainer = new javax.swing.JLabel();
        ...
        editprofiletrainer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/profile1.png"))); // NOI18N
        editprofiletrainer.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                editprofiletrainerMouseClicked(evt);
            }
        });
        jPanel2.add(editprofiletrainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, -1));
    ...
    manageclasses mc = new manageclasses();
        mc.trainer_id = this.trainer_id; // Passing the ID caught in displayUserInfo
        mc.setVisible(true);
        this.dispose();
    ...
    private void editprofiletrainerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editprofiletrainerMouseClicked
// // Open the Edit Profile Trainer form
    editprofiletrainer ept = new editprofiletrainer();
    ept.setVisible(true);
    
    // Close the current dashboard
    this.dispose();    // TODO add your handling code here:
    }//GEN-LAST:event_editprofiletrainerMouseClicked
   ...
   public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            if (config.UserSession.getInstance().getFullName() == null) {
                ...
                // Open the trainer dashboard normally
    ...
    private javax.swing.JLabel editprofiletrainer;
